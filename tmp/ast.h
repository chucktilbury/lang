...
typedef struct _ast_module_element_ {
    ast_type type;
    struct _ast_module_element_* value;
    struct _ast_module_element_* next;
} ast_module_element;
struct _ast_module_element_* create_module_element(
            struct _ast_module_element_* value);
void add_module_element(
            struct _ast_module_element_* node);
...
typedef struct _ast_module_body_ {
    ast_type type;
    struct _ast_module_element_* first;
    struct _ast_module_element_* last;
} ast_module_body;
...
struct _ast_scope_* create_scope(int scope);
...
typedef struct _ast_compound_reference_ {
    ast_type type;
    struct _ast_compound_reference_element_* first;
    struct _ast_compound_reference_element_* last;
} ast_compound_reference;
struct _ast_compound_reference_* create_compound_reference(
            struct _ast_compound_reference_element_* node);
...
typedef struct _ast_compound_reference_element_ {
    ast_type type;
    struct _ast_compound_reference_element_* value;
    struct _ast_compound_reference_element_* next;
} ast_compound_reference_element;
struct _ast_compound_reference_element_* create_compound_reference_element(
            struct _ast_compound_reference_element_* value);
void add_compound_reference_element(
            struct _ast_compound_reference_element_* node);
...
struct _ast_compound_name_* create_compound_name(STRLST* cname);
...
typedef struct _ast_array_reference_ {
    ast_type type;
    STRLST* name;
    struct _ast_array_reference_list_* list;
} ast_array_reference;
...
typedef struct _ast_namespace_definition_ {
    ast_type type;
    STRLST* name;
    struct _ast_namespace_block_* block;
} ast_namespace_definition;
